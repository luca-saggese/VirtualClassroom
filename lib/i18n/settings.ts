...
export const settingsItIT = {
  settings: {
    ...
    agentSettingsDesc: "Seleziona gli agenti partecipanti alla conversazione",
    ...
    autoAgentCount: 'Numero generato',
    ...
    agentsCollaborating: 'Agenti in collaborazione',
    agentsCollaboratingCount: 'Selezionati {count} agenti per la collaborazione',

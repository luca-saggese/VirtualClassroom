...
export const settingsItIT = {
  settings: {
    ...
    theme: 'Tema',
    themeDesc: 'Scegli la modalità tema (Chiaro/Scuro/Segui sistema)',
    themeOptions: {
      light: 'Chiaro',
      dark: 'Scuro',
    ...
    apiKey: 'Chiave API',
    apiKeyDesc: 'Configura la tua chiave API',
    apiBaseUrl: 'Endpoint API',
    apiBaseUrlDesc: "Configura l'endpoint API",
    apiKeyRequired: "La chiave API non può essere vuota",
    model: 'Configurazione modello',
    modelDesc: 'Configura il modello AI',
    modelPlaceholder: 'Inserisci o seleziona il nome del modello',
    ttsModel: 'Modello TTS',
    ttsModelDesc: 'Configura il modello TTS',
    ttsModelPlaceholder: 'Inserisci o seleziona il modello TTS',
    ttsModelOptions: {
      openaiTts: 'OpenAI TTS',
      azureTts: 'Azure TTS',
    },
    testConnection: 'Test connessione',
    testConnectionDesc: "Verifica se la configurazione API corrente è funzionante",
    testing: 'Test in corso...',
    agentSettings: 'Impostazioni agenti',
    agentSettingsDesc:
      'Seleziona gli agenti partecipanti alla conversazione. Seleziona 1 per modalità singolo agente, più di 1 per modalità multi-agente collaborativa.',
    agentMode: 'Modalità agente',
    agentModePreset: 'Modalità preimpostata',
    agentModeAuto: 'Generazione automatica',
    agentModeAutoDesc: "L'AI genera automaticamente ruoli adatti",
    autoAgentCount: 'Numero di agenti',
    autoAgentCountDesc: "Numero di ruoli generati (incluso l'insegnante)",
    atLeastOneAgent: 'Seleziona almeno 1 agente',
    singleAgentMode: 'Modalità singolo agente',
    directAnswer: 'Risposta diretta',
    multiAgentMode: 'Modalità multi-agente',
    agentsCollaborating: 'Collaborazione',
    agentsCollaboratingCount: '{count} agenti selezionati per la collaborazione',
    maxTurns: 'Numero massimo di turni',
    maxTurnsDesc: 'Numero massimo di turni di discussione tra agenti',
    priority: 'Priorità',
    actions: 'Azioni',
    actionCount: '{count} azioni',
    selectedAgent: 'Agente selezionato',
    selectedAgents: 'Agenti selezionati',
    required: 'Obbligatorio',
    agentNames: {
      'default-1': 'Insegnante AI',
      'default-2': 'Assistente AI',
      'default-3': 'Buontempone',
      'default-4': 'Mente curiosa',
      'default-5': 'Prendere appunti',
      'default-6': 'Pensatore profondo',
    },
    agentRoles: {
      teacher: 'Insegnante',
    ...
    agentDescriptions: {
      'default-1': 'Insegnante principale con spiegazioni chiare e strutturate',
      'default-2': 'Supporta il processo di apprendimento e aiuta a chiarire i concetti chiave',
      'default-3': 'Porta umorismo ed energia in classe',
      'default-4': 'Sempre curioso, ama chiedere perché e come',
      'default-5': 'Registra e organizza diligentemente le note di lezione',
      'default-6': "Pensa in profondità ed esplora l'essenza degli argomenti",
    },
    close: 'Chiudi',
    save: 'Salva',
    providers: 'LLM',
    addProviderDescription: 'Aggiungi provider di modelli personalizzati per estendere i modelli AI disponibili',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    providerTypes: {
      openai: 'Protocollo OpenAI',
      anthropic: 'Protocollo Claude',
      google: 'Protocollo Gemini',
    },
    modelCount: 'modelli',
    ...
    documentParser: 'Parser documenti',
    conversationSettings: 'Conversazione',
    keyboardShortcuts: 'Scorciatoie',
    generalSettings: 'Generali',
    systemSettings: 'Sistema',
    addProvider: 'Aggiungi',
    importFromClipboard: 'Importa dagli appunti',
    apiSecret: 'Chiave API',
    apiHost: 'Base URL',
    ...
    contextShort: 'ctx',
    outputWindow: 'Output',
    addProviderButton: 'Aggiungi',
    addProviderDialog: 'Aggiungi provider modello',
    providerName: 'Nome',
    providerNamePlaceholder: 'es. Il mio proxy OpenAI',
    providerNameRequired: 'Inserisci il nome del provider',
    providerApiMode: 'Modalità API',
    apiModeOpenAI: 'Protocollo OpenAI',
    apiModeAnthropic: 'Protocollo Claude',
    apiModeGoogle: 'Protocollo Gemini',
    defaultBaseUrl: 'Base URL predefinito',
    providerIcon: 'URL icona provider',
    requiresApiKey: 'Richiede chiave API',
    deleteProvider: 'Elimina provider',
    deleteProviderConfirm: 'Sei sicuro di voler eliminare questo provider?',
    cannotDeleteBuiltIn: 'Impossibile eliminare il provider integrato',
    resetToDefault: 'Ripristina predefinito',
    resetToDefaultDescription:
      'Ripristina la lista modelli alla configurazione predefinita (chiave API e Base URL verranno conservati)',
    resetConfirmDescription:
      'Questa operazione rimuoverà tutti i modelli personalizzati e ripristinerà la lista predefinita. La chiave API e il Base URL verranno conservati.',
    confirmReset: 'Conferma ripristino',
    resetSuccess: 'Ripristino alla configurazione predefinita riuscito',
    saveSuccess: 'Impostazioni salvate',
    saveFailed: 'Salvataggio fallito, riprova',
    cannotDeleteBuiltInModel: 'Impossibile eliminare il modello integrato',
    cannotEditBuiltInModel: 'Impossibile modificare il modello integrato',
    modelIdRequired: 'Inserisci ID modello',
    noModelsAvailable: 'Nessun modello disponibile per il test',
    providerMetadata: 'Metadati provider',
    editModel: 'Modifica modello',
    editModelDescription: 'Modifica configurazione e funzionalità del modello',
    addNewModel: 'Nuovo modello',
    addNewModelDescription: 'Aggiungi una nuova configurazione modello',
    modelId: 'ID modello',
    modelIdPlaceholder: 'es. gpt-4o',
    modelName: 'Nome visualizzato',
    modelNamePlaceholder: 'Facoltativo',
    modelCapabilities: 'Funzionalità',
    advancedSettings: 'Impostazioni avanzate',
    contextWindowLabel: 'Finestra di contesto',
    contextWindowPlaceholder: 'es. 128000',
    outputWindowLabel: 'Token di output massimi',
    outputWindowPlaceholder: 'es. 4096',
    testModel: 'Testa modello',
    deleteModel: 'Elimina',
    cancelEdit: 'Annulla',
    saveModel: 'Salva',
    modelsManagementDescription:
      'Gestisci i modelli per questo provider. Per selezionare il modello attivo, vai su "Generali".',
    howToUse: 'Come usare',
    step1ConfigureProvider:
      'Vai su "Provider modello", seleziona o aggiungi un provider e configura le impostazioni di connessione (chiave API, Base URL, ecc.)',
    step2SelectModel: 'Seleziona il modello che vuoi usare in "Modello attivo" qui sotto',
    step3StartUsing: 'Dopo il salvataggio, il sistema userà il modello selezionato',
    activeModel: 'Modello attivo',
    activeModelDescription: 'Seleziona il modello per le conversazioni AI e la generazione di contenuti',
    selectModel: 'Seleziona modello',
    searchModels: 'Cerca modelli',
    noModelsFound: 'Nessun modello corrispondente',
    noConfiguredProviders: 'Nessun provider configurato',
    configureProvidersFirst:
      'Configura le impostazioni di connessione del provider in "Provider modello" sulla sinistra',
    currentlyUsing: 'In uso',
    ttsSettings: 'Sintesi vocale',
    asrSettings: 'Riconoscimento vocale',
    audioSettings: 'Impostazioni audio',
    ttsSection: 'Sintesi vocale (TTS)',
    asrSection: 'Riconoscimento vocale (ASR)',
    ttsDescription: 'TTS (Text-to-Speech) - Converti testo in voce',
    asrDescription: 'ASR (Automatic Speech Recognition) - Converti voce in testo',
    enableTTS: 'Abilita sintesi vocale',
    ttsEnabledDescription: 'Quando abilitata, la voce verrà generata automaticamente durante la creazione del corso',
    enableASR: 'Abilita riconoscimento vocale',
    asrEnabledDescription: 'Quando abilitato, gli studenti possono usare il microfono per input vocale',
    ttsProvider: 'Provider TTS',
    ttsLanguageFilter: 'Filtro lingua',
    allLanguages: 'Tutte le lingue',
    ttsVoice: 'Voce',
    ttsSpeed: 'Velocità',
    ttsBaseUrl: 'Base URL',
    ttsApiKey: 'Chiave API',
    asrProvider: 'Provider ASR',
    asrLanguage: 'Lingua di riconoscimento',
    asrBaseUrl: 'Base URL',
    asrApiKey: 'Chiave API',
    enterApiKey: 'Inserisci chiave API',
    enterCustomBaseUrl: 'Inserisci Base URL personalizzato',
    browserNativeNote: 'ASR nativo del browser non richiede configurazione ed è completamente gratuito',
    providerOpenAITTS: 'OpenAI TTS (gpt-4o-mini-tts)',
    providerAzureTTS: 'Azure TTS',
    providerGLMTTS: 'GLM TTS',
    providerQwenTTS: 'Qwen TTS (Alibaba Cloud Bailian)',
    providerBrowserNativeTTS: 'TTS nativo del browser',
    providerOpenAIWhisper: 'OpenAI ASR (gpt-4o-mini-transcribe)',
    providerBrowserNative: 'ASR nativo del browser',
    providerQwenASR: 'Qwen ASR (Alibaba Cloud Bailian)',
    providerUnpdf: 'unpdf (Integrato)',
    providerMinerU: 'MinerU',
    browserNativeTTSNote:
      'TTS nativo del browser non richiede configurazione ed è gratuito, usa le voci di sistema',
    testTTS: 'Testa TTS',
    testASR: 'Testa ASR',
    testSuccess: 'Test riuscito',
    testFailed: 'Test fallito',
    ttsTestText: 'Testo di test TTS',
    ttsTestSuccess: 'Test TTS riuscito, audio riprodotto',
    ttsTestFailed: 'Test TTS fallito',
    asrTestSuccess: 'Riconoscimento vocale riuscito',
    asrTestFailed: 'Riconoscimento vocale fallito',
    asrResult: 'Risultato riconoscimento',
    asrNotSupported: 'Il browser non supporta le API di riconoscimento vocale',
    browserTTSNotSupported: 'Il browser non supporta le API di sintesi vocale',
    browserTTSNoVoices: 'Il browser corrente non ha voci TTS disponibili',
    microphoneAccessDenied: 'Accesso al microfono negato',
    microphoneAccessFailed: 'Accesso al microfono fallito',
    asrResultPlaceholder: 'Il risultato del riconoscimento verrà visualizzato dopo la registrazione',
    useThisProvider: 'Usa questo provider',
    fetchVoices: 'Ottieni lista voci',
    fetchingVoices: 'Recupero in corso...',
    voicesFetched: 'Voci ottenute',
    fetchVoicesFailed: 'Recupero voci fallito',
    voiceApiKeyRequired: 'Chiave API richiesta',
    voiceBaseUrlRequired: 'Base URL richiesto',
    ttsTestTextPlaceholder: 'Inserisci il testo da convertire',
    ttsTestTextDefault: 'Ciao, questo è un testo di test vocale.',
    startRecording: 'Avvia registrazione',
    stopRecording: 'Ferma registrazione',
    recording: 'Registrazione in corso...',
    transcribing: 'Trascrizione in corso...',
    transcriptionResult: 'Risultato trascrizione',
    noTranscriptionResult: 'Nessun risultato di trascrizione',
    baseUrlOptional: 'Base URL (Facoltativo)',
    defaultValue: 'Predefinito',
    voiceMarin: 'Consigliato - Qualità migliore',
    voiceCedar: 'Consigliato - Qualità migliore',
    voiceAlloy: 'Neutro, bilanciato',
    voiceAsh: 'Stabile, professionale',
    voiceBallad: 'Elegante, lirico',
    voiceCoral: 'Caldo, amichevole',
    voiceEcho: 'Maschile, chiaro',
    voiceFable: 'Narrativo, vivace',
    voiceNova: 'Femminile, brillante',
    voiceOnyx: 'Maschile, profondo',
    voiceSage: 'Saggio, composto',
    voiceShimmer: 'Femminile, morbido',
    voiceVerse: 'Naturale, fluido',
    glmVoiceTongtong: 'Voce predefinita',
    glmVoiceChuichui: 'Voce Chuichui',
    glmVoiceXiaochen: 'Voce Xiaochen',
    glmVoiceJam: 'Voce Jam',
    glmVoiceKazi: 'Voce Kazi',
    glmVoiceDouji: 'Voce Douji',
    glmVoiceLuodo: 'Voce Luodo',
    qwenVoiceCherry: 'Solare, calorosa e naturale',
    qwenVoiceSerena: 'Delicata e morbida',
    qwenVoiceEthan: 'Energetico e vivace',
    qwenVoiceChelsie: 'Ragazza virtuale anime',
    qwenVoiceMomo: 'Giocosa e allegra',
    qwenVoiceVivian: 'Carina e vivace',
    qwenVoiceMoon: 'Fresca e sicura di sé',
    qwenVoiceMaia: 'Intellettuale e dolce',
    qwenVoiceKai: 'Una SPA per le orecchie',
    qwenVoiceNofish: 'Designer dallo stile unico',
    qwenVoiceBella: 'Voce giovanile e frizzante',
    qwenVoiceJennifer: 'Voce femminile americana di qualità cinematografica',
    qwenVoiceRyan: 'Ritmo alto, performance drammatica',
    qwenVoiceKaterina: 'Signora matura con ritmo memorabile',
    qwenVoiceAiden: 'Ragazzo americano esperto di cucina',
    qwenVoiceEldricSage: 'Anziano stabile e saggio',
    qwenVoiceMia: 'Dolce come acqua di primavera',
    qwenVoiceMochi: 'Piccolo adulto sveglio con innocenza infantile',
    qwenVoiceBellona: 'Voce forte, pronuncia chiara, personaggi vivaci',
    qwenVoiceVincent: 'Voce roca unica che narra di guerra e onore',
    qwenVoiceBunny: 'Adorabile voce giovanile',
    qwenVoiceNeil: 'Anchorman professionale',
    qwenVoiceElias: 'Istruttore professionale',
    qwenVoiceArthur: 'Voce semplice intrisa di anni',
    qwenVoiceNini: 'Voce morbida e appiccicosa come riso glutinoso',
    qwenVoiceEbona: 'Il suo sussurro come una chiave arrugginita',
    qwenVoiceSeren: 'Voce delicata e rilassante per dormire meglio',
    qwenVoicePip: 'Birichino ma pieno di innocenza infantile',
    qwenVoiceStella: 'Voce da ragazza dolce che diventa autorevole',
    qwenVoiceBodega: 'Entusiasta zio spagnolo',
    qwenVoiceSonrisa: 'Entusiasta signora latinoamericana',
    qwenVoiceAlek: 'Freddo della nazione guerriera, caldo sotto il cappotto',
    qwenVoiceDolce: 'Pigro zio italiano',
    qwenVoiceSohee: 'Dolce e allegra unnie coreana',
    qwenVoiceOnoAnna: "Amica d'infanzia dispettosa",
    qwenVoiceLenn: 'Giovane tedesco razionale che ascolta post-punk',
    qwenVoiceEmilien: 'Romantico fratello maggiore francese',
    qwenVoiceAndre: 'Voce maschile magnetica, naturale e calma',
    qwenVoiceRadioGol: 'Il poeta del calcio Rádio Gol!',
    qwenVoiceJada: 'Vivace signora di Shanghai',
    qwenVoiceDylan: 'Ragazzo di Pechino',
    qwenVoiceLi: 'Insegnante di yoga paziente',
    qwenVoiceMarcus: 'Viso largo, parole brevi, cuore solido',
    qwenVoiceRoy: 'Ragazzo taiwanese umoristico e diretto',
    qwenVoicePeter: 'Professionista dello stand-up di Tianjin',
    qwenVoiceSunny: 'Dolce ragazza del Sichuan',
    qwenVoiceEric: 'Gentiluomo di Chengdu',
    qwenVoiceRocky: 'Simpatico ragazzo di Hong Kong',
    qwenVoiceKiki: 'Dolce ragazza di Hong Kong',
    ...
    'lang_af-ZA': 'Afrikaans (Suid-Afrika)',
    'lang_uk-UA': 'Українська (Україна)',
    pdfSettings: 'Analisi PDF',
    pdfParsingSettings: 'Impostazioni analisi PDF',
    pdfDescription: 'Scegli il motore di analisi PDF con supporto per estrazione testo, immagini e tabelle',
    pdfProvider: 'Parser PDF',
    pdfFeatures: 'Funzionalità supportate',
    pdfApiKey: 'Chiave API',
    pdfBaseUrl: 'Base URL',
    mineruDescription:
      'MinerU è un servizio PDF commerciale con funzionalità avanzate come estrazione tabelle, riconoscimento formule e analisi layout.',
    mineruApiKeyRequired: "Devi richiedere una chiave API sul sito MinerU prima dell'uso.",
    mineruWarning: 'Attenzione',
    mineruCostWarning:
      'MinerU è un servizio commerciale e può comportare costi. Consulta il sito MinerU per i dettagli sui prezzi.',
    enterMinerUApiKey: 'Inserisci chiave API MinerU',
    mineruLocalDescription:
      'MinerU supporta la distribuzione locale con analisi PDF avanzata (tabelle, formule, analisi layout). Richiede il deployment del servizio MinerU.',
    mineruServerAddress: 'Indirizzo server MinerU locale (es. http://localhost:8080)',
    mineruApiKeyOptional: "Richiesta solo se il server ha l'autenticazione abilitata",
    optionalApiKey: 'Chiave API facoltativa',
    featureText: 'Estrazione testo',
    featureImages: 'Estrazione immagini',
    featureTables: 'Estrazione tabelle',
    featureFormulas: 'Riconoscimento formule',
    featureLayoutAnalysis: 'Analisi layout',
    featureMetadata: 'Metadati',
    enableImageGeneration: 'Abilita generazione immagini AI',
    imageGenerationDisabledHint:
      'Quando abilitata, le immagini verranno generate automaticamente durante la creazione del corso',
    imageSettings: 'Generazione immagini',
    imageSection: 'Testo in immagine',
    imageProvider: 'Provider generazione immagini',
    imageModel: 'Modello generazione immagini',
    providerSeedream: 'Seedream (ByteDance)',
    providerQwenImage: 'Qwen Image (Alibaba)',
    providerNanoBanana: 'Nano Banana (Gemini)',
    testImageGeneration: 'Testa generazione immagini',
    testImageConnectivity: 'Testa connessione',
    imageConnectivitySuccess: 'Servizio immagini connesso con successo',
    imageConnectivityFailed: 'Connessione al servizio immagini fallita',
    imageTestSuccess: 'Test generazione immagini riuscito',
    imageTestFailed: 'Test generazione immagini fallito',
    imageTestPromptPlaceholder: 'Inserisci descrizione immagine per il test',
    imageTestPromptDefault: 'Un gatto carino seduto su una scrivania',
    imageGenerating: 'Generazione immagine in corso...',
    imageGenerationFailed: 'Generazione immagine fallita',
    enableVideoGeneration: 'Abilita generazione video AI',
    videoGenerationDisabledHint:
      'Quando abilitata, i video verranno generati automaticamente durante la creazione del corso',
    videoSettings: 'Generazione video',
    videoSection: 'Testo in video',
    videoProvider: 'Provider generazione video',
    videoModel: 'Modello generazione video',
    providerSeedance: 'Seedance (ByteDance)',
    providerKling: 'Kling (Kuaishou)',
    providerVeo: 'Veo (Google)',
    providerSora: 'Sora (OpenAI)',
    testVideoGeneration: 'Testa generazione video',
    testVideoConnectivity: 'Testa connessione',
    videoConnectivitySuccess: 'Servizio video connesso con successo',
    videoConnectivityFailed: 'Connessione al servizio video fallita',
    testingConnection: 'Test in corso...',
    videoTestSuccess: 'Test generazione video riuscito',
    videoTestFailed: 'Test generazione video fallito',
    videoTestPromptDefault: 'Un gatto carino che cammina su una scrivania',
    videoGenerating: 'Generazione video in corso (durata stimata 1-2 min)...',
    videoGenerationWarning: 'La generazione video richiede solitamente 1-2 minuti, attendere',
    mediaRetry: 'Riprova',
    mediaContentSensitive: 'Spiacente, questo contenuto ha attivato un controllo di sicurezza.',
    mediaGenerationDisabled: 'Generazione disabilitata nelle impostazioni',
    singleAgent: 'Singolo agente',
    multiAgent: 'Multi-agente',
    selectAgents: 'Seleziona agenti',
    noVisionWarning:
      "Il modello corrente non supporta la visione. Le immagini possono ancora essere inserite nelle slide, ma il modello non può interpretarle per ottimizzare la selezione e il layout",
    serverConfigured: 'Server',
    serverConfiguredNotice:
      "L'amministratore ha configurato una chiave API per questo provider sul server. Puoi usarla direttamente o inserire la tua per sovrascriverla.",
    optionalOverride: 'Facoltativo — lascia vuoto per usare la configurazione del server',
    setupNeeded: 'Configurazione richiesta',
    modelNotConfigured: 'Seleziona un modello per iniziare',
    dangerZone: 'Zona pericolosa',
    clearCache: 'Svuota cache locale',
    clearCacheDescription:
      'Elimina tutti i dati archiviati localmente, inclusi record delle lezioni, cronologia chat, cache audio e impostazioni. Questa operazione è irreversibile.',
    clearCacheConfirmTitle: 'Svuotare tutta la cache?',
    clearCacheConfirmDescription:
      'Questa operazione eliminerà permanentemente tutti i seguenti dati e non potrà essere annullata:',
    clearCacheConfirmItems:
      'Lezioni e scene, Cronologia chat, Cache audio e immagini, Impostazioni e preferenze',
    clearCacheConfirmInput: 'Digita "ELIMINA" per continuare',
    clearCacheConfirmPhrase: 'ELIMINA',
    clearCacheButton: 'Elimina definitivamente tutti i dati',
    clearCacheSuccess: 'Cache svuotata, la pagina si aggiornerà a breve',
    clearCacheFailed: 'Svuotamento cache fallito, riprova',
    webSearchSettings: 'Ricerca web',
    webSearchApiKey: 'Chiave API Tavily',
    webSearchApiKeyPlaceholder: 'Inserisci la tua chiave API Tavily',
    webSearchApiKeyPlaceholderServer: 'Chiave server configurata, sovrascrittura facoltativa',
    webSearchApiKeyHint: 'Ottieni una chiave API da tavily.com per la ricerca web',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: 'Chiave API Tavily lato server configurata',
    optional: 'Facoltativo',
  },
  profile: {
    title: 'Profilo',
    defaultNickname: 'Studente',
    chooseAvatar: 'Scegli avatar',
    uploadAvatar: 'Carica',
    bioPlaceholder: "Presentati brevemente; l'insegnante AI personalizzerà le lezioni",
    avatarHint: 'Il tuo avatar verrà visualizzato nelle discussioni e nelle chat della classe',
    fileTooLarge: 'Immagine troppo grande, scegli un file < 5MB',
    invalidFileType: 'Seleziona un file immagine valido',
    editTooltip: 'Clicca per modificare il profilo',
  },
  media: {
    imageCapability: 'Generazione immagini',
    imageHint: 'Genera immagini per le slide',
    videoCapability: 'Generazione video',
    videoHint: 'Genera video per il corso',
    ttsCapability: 'Sintesi vocale',
    ttsHint: "Voce dell'insegnante AI",
    asrCapability: 'Riconoscimento vocale',
    asrHint: 'Input vocale per partecipare alla discussione',
    provider: 'Provider',
    model: 'Modello',
    voice: 'Voce',
    speed: 'Velocità',
